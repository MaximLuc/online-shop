									...
									@auth
										@if (Auth::user()->utype ==='ADM')
											<li class="menu-item menu-item-has-children parent" >
												<a title="Admin-accaunt" href="#">Admin: ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
										...
										@else
											<li class="menu-item menu-item-has-children parent" >
												<a title="User-accaunt" href="#">User: ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
												<ul class="submenu curency" >
													<li class="menu-item" >
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="/news" class="link-term mercado-item-title">News</a>
								</li>
								<li class="menu-item">
