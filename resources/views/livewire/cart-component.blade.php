			...
			<div class=" main-content-area">
					...
					@if(Cart::count())
						...
						<ul class="products-cart">
							...
							<li class="pr-cart-item">
								...
								<div class="price-field produtc-price"><p class="price">{{$item->model->regular_price}} grn</p></div>
								<div class="quantity">
									<div class="quantity-input">
										<input type="text" name="product-quatity" value="{{$item->qty}}" data-max="120" pattern="[0-9]*">									
										<a class="btn btn-increase"style="text-align:center;" wire:click.prevent="increaseQuantity('{{$item->rowId}}')"></a>
										<a class="btn btn-reduce"  wire:click.prevent="decreaseQuantity('{{$item->rowId}}')"></a>
									</div>
								</div>
								<div class="price-field sub-total"><p class="price">{{$item->subtotal}}</p></div>
								<div class="delete">
									<a href="#" class="btn btn-delete" title="Delete" wire:click.prevent="delete('{{$item->rowId}}')">
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Subtotal</span><b class="index">{{Cart::subtotal()}} grn</b></p>
						<p class="summary-info"><span class="title">Tax</span><b class="index">{{Cart::tax()}} grn</b></p>
					...
					<div class="update-clear">
						<a class="btn btn-clear" href="#" wire:click.prevent="deleteAll('{{$item->rowId}}')">Clear Shopping Cart</a>
				...
				@else
					<div class="text-center" style="padding:30px 0px">
						...
						<h3>Add product in cart now </h3>
						<a href="/shop" class="btn btn-success mt-5">To Shop</a>
