						...
						<div class="wrap-right">
							...
							<div class="sort-item orderby ">
								<select name="orderby" class="use-chosen" wire:model="sorting" >
									...
									<option value="not_alphabetically">not alphabetically</option>
								...
								<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
									<div class="product product-style-3 equal-elem ">
										<div class="product-thumnail">
											<a href="{{route('product.datails',['slug'=>$p->slug])}}" 
												title="{{$p->name}}">
												<figure>
													<img src="{{ asset('assets/images/products') }}/{{$p->image}}" 
														alt="{{ asset('assets/images/products') }}/{{$p->image}}">
												</figure>
											</a>
										</div>
										<div class="product-info">
											<a href="{{route('product.datails',['slug'=>$p->slug])}}" class="product-name"><span>{{$p->name}}</span></a>
											<div class="wrap-price"><span class="product-price">{{$p->regular_price}} грн</span></div>
											<a href="{{route('product.cart')}}" class="btn add-to-cart" wire:click.prevent="store({{$p->id}},'{{$p->name}}',{{$p->regular_price}})">Add To Cart</a>
										</div>
									</div>
								</li>
							@endforeach
